...
const updateProject = async (req, res, next) => {
  ...
  const { projectKey, designerId, designNumber, projectAdress, finalDate } = req.body;
  ...
  const project = new Project({ userId, projectKey, designerId, designNumber, projectAdress, finalDate });
